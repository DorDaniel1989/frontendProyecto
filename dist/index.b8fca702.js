...
$(document).ready(function() {
    ...
    headersA.append('Access-Control-Allow-Origin', 'http://localhost:1234');
    ...
    fetch('https://localhost:5001/api/TiempoItems').then((response)=>response.json()
    ).then((registrosTiempo)=>{
        //Control de LocalStorage
        var oLocalidadesSeleccionadas = {
            'cero': 'irun',
            'uno': 'orio',
            'dos': 'aia'
        };
        ...
        localStorage.setItem('oLocalidadesSeleccionadas', JSON.stringify(oLocalidadesSeleccionadas));
        localStorage.setItem('numeroMaximoOpciones', JSON.stringify(numeroMaximoOpciones));
        //Si es la primera vez que entramos a la Web
        if (localStorage.getItem('oLocalidadesSeleccionadas') === null) ;
        else {
            var testObjectReturn = localStorage.getItem('oLocalidadesSeleccionadas');
    ...
    function registrarUsuario() {
        ...
        headers.append('Access-Control-Allow-Origin', 'http://localhost:1234');
    ...
    function loguear(user, pass) {
        ...
        headersL.append('Access-Control-Allow-Origin', 'http://localhost:1234');
    ...
    function getFichaDesdeApi(nombreMunicipio) {
        fetch(`https://localhost:5001/api/TiempoItems/${nombreMunicipio}`, {
            headers: {
  ...
  <ul class="list-group list-group-flush droppable" id="ul_${objetoJSON.municipio}">
    ...
    function crearObjetoFichaLocalStorage(oJSON) {
        let infoMunicipio = {
            municipio: `${oJSON.municipio}`,
            temperatura: `${oJSON.temperatura}`,
            tempMax: `${oJSON.tempMax}`,
            tempMin: `${oJSON.tempMin}`,
            tempMedia: `${oJSON.tempMedia}`,
            humedad: `${oJSON.humedad}`,
            precipitacionAcumulada: `${oJSON.precipitacionAcumulada}`,
            velocidadViento: `${oJSON.velocidadViento}`,
            descripcion: `${oJSON.descripcion}`,
            fecha: `${oJSON.fecha}`,
            latitud: `${oJSON.latitud}`,
            longitud: `${oJSON.longitud}`,
            opciones: {
                precipitacion: false,
                humedad: false,
                viento: false,
    ...
    function crearFicha(objetoJson) {
        if (!comprobarNumeroMaximoDeCartasLocalStorage()) console.log("no se puede insertar mas elementos");
            ...
            $(`.borrarCartas`).click(function() {
                ...
                map.eachLayer((layer)=>{
                    if (layer.options.Id === $(this).parent().parent()[0].id) layer.remove();
                });
            });
            ...
            $(`.droppable`).droppable({
                drop: function(event, ui) {
                    ...
                    switch(idParametro){
                        case "precipitaciones":
                            if (!JSON.parse(localStorage.getItem(`${$idCarta}`)).opciones.precipitacion) {
                                $(this).append(`<li class="list-group-item borrable" id="prec_${$idCarta}"><img class="icono" src="./images/drop32.png" alt=>${JSON.parse(localStorage.getItem(`${$idCarta}`)).precipitacionAcumulada} ml <div class="borrarInfo">X</div></li>`);
                                objetoLS.opciones.precipitacion = true;
                                localStorage.setItem(`${$idCarta}`, JSON.stringify(objetoLS));
                            }
                            break;
                        case "velocidadViento":
                            if (!JSON.parse(localStorage.getItem(`${$idCarta}`)).opciones.viento) {
                                $(this).append(`<li class="list-group-item borrable" id="vien_${$idCarta}"><img class="icono" src="./images/wind32.png" alt=>${JSON.parse(localStorage.getItem(`${$idCarta}`)).velocidadViento} Km/h <div class="borrarInfo">X</div></li>`);
                                objetoLS.opciones.viento = true;
                                localStorage.setItem(`${$idCarta}`, JSON.stringify(objetoLS));
                            }
                            break;
                        case "humedad":
                            if (!JSON.parse(localStorage.getItem(`${$idCarta}`)).opciones.humedad) {
                                $(this).append(`<li class="list-group-item borrable" id="hume_${$idCarta}"><img class="icono" src="./images/humedad32.png" alt=>${JSON.parse(localStorage.getItem(`${$idCarta}`)).humedad}  <div class="borrarInfo">X</div></li>`);
                        ...
                        case "tempMax":
                            if (!JSON.parse(localStorage.getItem(`${$idCarta}`)).opciones.tempMax) {
                                $(this).append(`<li class="list-group-item borrable" id="tmax_${$idCarta}"><img class="icono" src="./images/temperatura-alta32.png" alt=>${JSON.parse(localStorage.getItem(`${$idCarta}`)).tempMax}  <div class="borrarInfo">X</div></li>`);
                        ...
                        case "tempMin":
                            if (!JSON.parse(localStorage.getItem(`${$idCarta}`)).opciones.tempMin) {
                                $(this).append(`<li class="list-group-item borrable" id="tmin_${$idCarta}"><img class="icono" src="./images/frio32.png" alt=>${JSON.parse(localStorage.getItem(`${$idCarta}`)).tempMin}  <div class="borrarInfo">X</div></li>`);
                        ...
                        case "tempMedia":
                            if (!JSON.parse(localStorage.getItem(`${$idCarta}`)).opciones.tempMedia) {
                                $(this).append(`<li class="list-group-item borrable" id="tmed_${$idCarta}"><img class="icono" src="./images/tempMedia32.png" alt=>${JSON.parse(localStorage.getItem(`${$idCarta}`)).tempMedia.substring(0, 3)} <div class="borrarInfo">X</div></li>`);
                    ...
                    $(`.borrarInfo`).click(function() {
                        ...
                        var opt = $(this).parents()[0];
                        var loc = $(this).parents()[2];
    ...
    function cambiarOpcionAFalse(idOpcion, idCarta) {
        ...
        switch(idOpcion){
            case "prec":
                objetoLS.opciones.precipitacion = false;
                localStorage.setItem(`${$idCarta}`, JSON.stringify(objetoLS));
            case "hume":
                objetoLS.opciones.humedad = false;
                localStorage.setItem(`${$idCarta}`, JSON.stringify(objetoLS));
            case "vien":
                objetoLS.opciones.viento = false;
                localStorage.setItem(`${$idCarta}`, JSON.stringify(objetoLS));
            case "tmax":
                objetoLS.opciones.tempMax = false;
                localStorage.setItem(`${$idCarta}`, JSON.stringify(objetoLS));
            case "tmin":
                objetoLS.opciones.tempMin = false;
                localStorage.setItem(`${$idCarta}`, JSON.stringify(objetoLS));
            case "tmed":
                objetoLS.opciones.tempMedia = false;
                localStorage.setItem(`${$idCarta}`, JSON.stringify(objetoLS));
        }
    }
